# %%
# =========================================================
# MOMA -> FLUX FEATURE MATRIX PIPELINE
# Combined & Improved
#
...
MIN_ACTIVITY      = 0.5              # floor of sigmoid mapping [fitness -> activity]
...
SLACK_FACTOR      = 0.5              # residual capacity fraction when activity -> 0
                                     #   activity=0 -> 50% retained  (continuous inhibition)
